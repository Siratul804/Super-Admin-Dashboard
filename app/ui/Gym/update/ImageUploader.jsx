...
import { updateImg } from "@/app/lib/actions";
import { useFormState } from "react-dom";

const ImageUploader = ({ id }) => {
  const [previewImage, setPreviewImage] = useState(null);
  const [state, formAction] = useFormState(updateImg, undefined);
    ...
    <>
      <div className="flex flex-col items-center justify-start  mb-4 ">
        ...
        >
          ...
          >
            <span class="ml-3 text-gray-600 text-sm ">Update Member Image</span>
          </label>
        </button>
