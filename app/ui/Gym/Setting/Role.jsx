...
const Role = ({ RolePaginationData, RolePaginationCount, user }) => {
  const gymIds = RolePaginationData.map((val) => val.gym_id);

  const id_num = user.gym_id;

  const isIdIncluded = gymIds.includes(id_num);

  console.log(id_num, gymIds);
  ...
  return (
    <>
      ...
      <section className="bg-white w-full shadow-lg rounded-lg">
        <div className="">
          <div className="p-3  flex justify-between  ">
            ...
            <Link
              ...
              href={`/dashboard/gym/createGymRole/${id_num}`}
        ...
        {/* Table */}
        <div className="overflow-x-auto w-full h-[52vh] ">
                  ...
                  <>
                    {RolePaginationData.filter(
                      ...
                      />
                            ...
                            <td className="px-6 py-4 whitespace-no-wrap border-b border-gray-200 ">
                              <Link
                                href={`/dashboard/gym/editGymRole/${val.id}`}
